...
def run_bug_fix(
    ...
    """
    logger.info('-' * 100)
    logger.info(f'Bug fix on {args.bug_fix_scale} dataset')
    # --------------------------------------------------
    # datasets
    # --------------------------------------------------
    logger.info('-' * 100)
    ...
    training_args = Seq2SeqTrainingArguments(output_dir=os.path.join(args.checkpoint_root, enums.TASK_BUG_FIX),
                                             ...
                                             logging_dir=os.path.join(args.tensor_board_root, enums.TASK_BUG_FIX),
